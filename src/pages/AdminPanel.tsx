          ...
          <TabsContent value="whatsapp" className="space-y-4">
            <div className="flex flex-col md:flex-row gap-6 items-start">
              ...
              <div className="flex-1 min-w-0 p-4 sm:p-6 bg-card rounded-lg space-y-5">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Configure a mensagem enviada quando um cliente clica para encomendar.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      className="mt-1.5"
                    />
                    <p className="text-[11px] text-muted-foreground mt-1">Código do país + DDD + número (ex: 5511999999999)</p>
                  </div>

                  <div>
                    <Label htmlFor="whatsappTemplate" className="text-sm font-medium">Modelo da Mensagem</Label>
                    <Textarea
                      id="whatsappTemplate"
                  ...
                  <div className="bg-muted/50 rounded-lg p-4 space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="flex items-start gap-2.5 bg-background rounded-lg p-2.5 border">
                        <code className="bg-primary/10 text-primary px-2 py-0.5 rounded text-[11px] font-mono font-bold shrink-0">{'{produto}'}</code>
                        <span className="text-[11px] text-muted-foreground leading-tight pt-0.5">Nome do produto</span>
                      </div>
                      <div className="flex items-start gap-2.5 bg-background rounded-lg p-2.5 border">
                        <code className="bg-primary/10 text-primary px-2 py-0.5 rounded text-[11px] font-mono font-bold shrink-0">{'{quantidade}'}</code>
                        <span className="text-[11px] text-muted-foreground leading-tight pt-0.5">Quantidade escolhida</span>
                      </div>
                      <div className="flex items-start gap-2.5 bg-background rounded-lg p-2.5 border">
                        <code className="bg-primary/10 text-primary px-2 py-0.5 rounded text-[11px] font-mono font-bold shrink-0">{'{tamanho}'}</code>
                      ...
                      <div className="flex items-start gap-2.5 bg-background rounded-lg p-2.5 border">
                        ...
                        <span className="text-[11px] text-muted-foreground leading-tight pt-0.5">Link direto do produto</span>
                      </div>
                      <div className="flex items-start gap-2.5 bg-background rounded-lg p-2.5 border">
                        <code className="bg-primary/10 text-primary px-2 py-0.5 rounded text-[11px] font-mono font-bold shrink-0">{'{categoria}'}</code>
                        <span className="text-[11px] text-muted-foreground leading-tight pt-0.5">Categoria do produto</span>
                      </div>
                      <div className="flex items-start gap-2.5 bg-background rounded-lg p-2.5 border">
                        <code className="bg-primary/10 text-primary px-2 py-0.5 rounded text-[11px] font-mono font-bold shrink-0">{'{descricao}'}</code>
                        <span className="text-[11px] text-muted-foreground leading-tight pt-0.5">Descrição do produto</span>
                      </div>
                    </div>
                    <p className="text-[10px] text-muted-foreground italic">
                      Use *texto* para colocar em negrito. Use \n para quebrar linha.
                    </p>
                  </div>
                </div>
              ...
              <div className="w-full md:w-[300px] flex-shrink-0 flex flex-col items-center md:sticky md:top-4">
                ...
                {/* Celular */}
                <div className="relative w-[260px] h-[480px] bg-[#111b21] rounded-[32px] p-[8px] shadow-2xl">
                  {/* Tela */}
                  <div className="w-full h-full bg-[#efeae2] rounded-[26px] overflow-hidden flex flex-col">
                    
                    {/* Barra superior WhatsApp */}
                    <div className="bg-[#008069] px-3 py-2.5 flex items-center gap-2.5">
                      <svg className="w-4 h-4 text-white/80" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z"/>
                      </svg>
                      <div className="w-9 h-9 rounded-full bg-[#d9dbdc] flex items-center justify-center shrink-0">
                        <svg className="w-6 h-6 text-[#5e6c74]" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z"/>
                        </svg>
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="text-white text-[13px] font-medium leading-tight truncate">Fabiana Designs</p>
                        <p className="text-white/70 text-[10px] leading-tight">online</p>
                      </div>
                      <div className="flex gap-3.5 shrink-0">
                        <svg className="w-[18px] h-[18px] text-white/80" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="flex-1 overflow-y-auto p-3 space-y-2" style={{
                      ...
                      <div className="flex justify-end">
                        <div className="bg-[#d9fdd3] rounded-lg rounded-tr-sm px-2.5 py-1.5 max-w-[88%] shadow-sm relative">
                          {/* Seta da mensagem */}
                          <div className="absolute top-0 right-[-5px] w-0 h-0 border-t-[5px] border-t-[#d9fdd3] border-l-[5px] border-l-transparent" />
                          ...
                          <div className="flex items-center justify-end gap-0.5 mt-0.5">
                            ...
                            <svg className="w-[14px] h-[14px] text-[#53bdeb] ml-0.5" viewBox="0 0 16 11" fill="currentColor">
                    ...
                    <div className="bg-[#f0f2f5] px-2 py-2 flex items-center gap-2">
                      ...
                      <div className="flex-1 bg-white rounded-full px-3 py-2 border border-[#e4e6e8]">
                        <span className="text-[11px] text-[#667781]">Mensagem</span>
                      </div>
                      <div className="w-8 h-8 rounded-full flex items-center justify-center shrink-0">
                        <svg className="w-5 h-5 text-[#8696a0]" fill="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-[11px] text-muted-foreground mt-4 text-center max-w-[260px] leading-relaxed">
                  Assim o cliente verá a mensagem ao clicar em <strong>"Encomendar"</strong>
                </p>
              </div>
            </div>
          </TabsContent>
